            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="first-container">
                        <h1 class="big-text">
                            <?php if ( $big_text = get_field( 'big_text' ) ) : ?>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="second-container">
                        ...
                        <div class="nav-menu">
                            <a href="<?php echo site_url(); ?>" class="active">about me</a>
                        ...
                        <div class="footer-link">
                            <a href="https://github.com/chrisml-01" target="_blank">
                                <svg version="1.1" id="github-link" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <a href="https://www.linkedin.com/in/christianne-marie-luntok-13985519b/" target="_blank">
                                <svg id="linkedin-link" height="20px" viewBox="0 0 512 512" width="20px" xmlns="http://www.w3.org/2000/svg">
